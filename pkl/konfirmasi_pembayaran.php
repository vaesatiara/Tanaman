...
// PERBAIKAN: Jika ini pesanan baru, ambil dari session current_order
...
// PERBAIKAN UTAMA: Cek pembayaran dengan lebih ketat
$pembayaran_exists = false;
$show_payment_form = true; // Default: tampilkan form
...
if ($pesanan_data) {
    ...
    if (in_array($pesanan_data['status_pesanan'], ['selesai', 'dibatalkan'])) {
        $show_payment_form = false;
        $pembayaran_exists = true; // Anggap sudah ada pembayaran
    }
    ...
    if (!$pesanan_data) {
        ...
        try {
            ...
            if (isset($_FILES['file_image']) && $_FILES['file_image']['error'] === UPLOAD_ERR_OK) {
                ...
                if ($_FILES['file_image']['size'] > 2 * 1024 * 1024) { // 2MB
            ...
            $success_message = "Konfirmasi pembayaran berhasil dikirim. Tim kami akan memverifikasi pembayaran Anda dalam 1x24 jam.";
    ...
    <main class="confirmation-section">
        <div class="container">
            ...
            <?php if (!empty($success_message)): ?>
                <div class="success-message" style="background-color: #d4edda; color: #155724; padding: 15px; border-radius: 5px; margin: 20px 0;">
                    <p><i class="fas fa-check-circle"></i> <?= htmlspecialchars($success_message) ?></p>
                    <p><a href="riwayat_pesanan.php" class="btn btn-primary">Lihat Riwayat Pesanan</a></p>
                </div>
            <?php endif; ?>
                    ...
                    <div class="form-card">
                        ...
                        <div class="payment-details">
                            ...
                            <div class="detail-row">
                                ...
                                <span><?= htmlspecialchars($pesanan_data['status_pesanan']) ?></span>
                            </div>
                        </div>
                        ...
                        <?php else: ?>
                            <div class="payment-confirmed">
                                ...
                                <?php elseif (in_array($pesanan_data['status_pesanan'], ['menunggu_verifikasi', 'diverifikasi'])): ?>
                                    Pembayaran untuk pesanan ini sudah dikonfirmasi dan sedang diverifikasi.
                                <?php else: ?>
